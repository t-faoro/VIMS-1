...
class Login{
	...
	*/
	public function set_login_display(){
		...
		$login .= '<div class="item"><label for="username">Username:</label><input class="text" id="username" type="text" name="username" /></div>';
		...
		$login .= '<div class="item"><label for="vID">Venue ID:</label><input class="textField" id="vid" type="text" name="vid" /></div>';
